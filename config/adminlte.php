...
return [
    ...
    */
    ...
    'title' => '',
    'title_prefix' => '',
    'title_postfix' => '| Magic Hands Administrador',
    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'url'  => 'admin/settings',
            'icon' => 'fas fa-fw fa-home fa-lg mr-1',
        ],
        [
            'text' => 'Calendario',
            //'url'  => '#',
            'route'  => 'citas.calendario',
            'icon' => 'fas fa-fw fa-calendar fa-lg mr-1',
        ],
        [
            'text' => 'Consultorios',
        ...
        [
            ...
            'icon' => 'fa fa-fw fa-user fa-lg mr-1',
        ],
        [
            'text' => 'Podólogos',
            'route'  => 'podologas.index',
            'icon' => 'fas fa-fw fa-user-md fa-lg mr-1',
        ],
        [
            'text' => 'Atención / Cita',
            'route'  => 'citas.index',
        ...
        [
            ...
            'url'  => '#',
            //'route'  => 'pacientes.index',
            'icon' => 'fas fa-fw fa-users fa-lg mr-1',
        ],
        [
            'text' => 'Gastos',
            'url'  => '#',
            //'route'  => 'pacientes.index',
            'icon' => 'fas fa-fw fa-credit-card fa-lg mr-1',
        ],
        /*[
        ...
        'InputMask' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '//rawgit.com/RobinHerbots/jquery.inputmask/3.x/dist/jquery.inputmask.bundle.js',
                ],
            ],
        ],
        'Layout' => [
